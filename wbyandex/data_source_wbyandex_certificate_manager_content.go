...
func dataSourceWebbankirYandexCertificateManagerContent() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceWebbankirYandexCertificateManagerContentRead,
...
func dataSourceWebbankirYandexCertificateManagerContentRead(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	ctx := config.Context()
