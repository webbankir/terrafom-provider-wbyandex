...
func dataSourceWebbankirYandexCertificateManagerList() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceWebbankirYandexCertificateManagerListRead,
...
func dataSourceWebbankirYandexCertificateManagerListRead(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	ctx := config.Context()
