...
func dataSourceWebbankirYandexLockBoxSecretPayload() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceWebbankirYandexLockBoxSecretPayloadRead,
...
func dataSourceWebbankirYandexLockBoxSecretPayloadRead(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	ctx := config.Context()
